	...
	$.fn.sinaNav = function () {
		return this.each( function() {
			...
			getNav.find('.sina-menu, .extension-nav').each(function(){
				...
				$('.mega-menu-col', menu).children('.sub-menu').removeClass('sub-menu animated');
			});
			...
			if( getWindow < 992 ) {
				...
				getNav.find('.menu-item-has-mega-menu').each(function(){
					...
					$('.mega-menu-col', megamenu).children('.sub-menu').addClass('sub-menu animated');
					...
					$(megamenu).on('mouseleave', function() {
						$('.sub-menu', megamenu).stop().fadeOut().removeClass(getIn);
						$('.mega-menu-col', megamenu).removeClass('on');
					});
				});
                // set href javascript void(0) whose nav have childrens
                $(".sina-nav .sina-menu li.menu-item-has-children > a").attr("href","javascipt:void(0);");
			}
		});
	}
	// Initialize
